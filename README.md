...
My motto is "go fast and break things" — but I write tests now, so mostly things stay unbroken.
...
- 📍 Building at [Spot Parking](https://github.com/spotparking)
- 📈 Leveling up on testing (Vitest, Playwright) and backend architecture patterns
- 🎵 Probably listening to whatever my own Discord bot is queuing up
- ⚔️ Sharpening fundamentals on [Codewars](https://www.codewars.com)

## 📫 Find me

- 🌐 [nickhgriffiths.com](https://nickhgriffiths.com)
- 💼 [LinkedIn](https://www.linkedin.com/in/nicholas-griffiths-1a1883220/)
- ✍️ [Medium](https://medium.com/@nichg999) — where I write about what I'm learning

---

*Open to frontend and full-stack opportunities — if you want to talk shop about React, event sourcing, or why your Discord server needs a better music bot, reach out.*
